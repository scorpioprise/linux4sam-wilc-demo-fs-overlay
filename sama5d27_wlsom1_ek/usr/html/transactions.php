            ...
            <div class="row py-2 ms-0">
                <div class="col-7 col-md-6 col-lg-4 d-flex align-items-center me-lg-1 mb-lg-0 mb-1 text-break rounded-4 bg-grigiochiaro" style="min-height: 80px;">
                    <div class="icon-square flex-shrink-0 mt-1 me-3">
                        <img src="img/ico_transazioni_grande.png">
                    </div>
                    <div>
                                ...
                                if ($stmt = mysqli_prepare($link, $sql)) {
                                    if (mysqli_stmt_execute($stmt)) {
                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            echo "<tr><td>" . $row['id'] . "</td><td>" . $row['tempo'] . "</td><td class='text-break'>" . $row['card_no'] . "</td><td class='text-break'>" . $row['name'] . "</td><td>" . $row['status'] . "</td><td>" . $row['start_time'] . "</td><td>" . $row['end_time'] . "</td><td>" . $row['duration'] . "</td><td>" . $row['delivered_kwh'] . "</td><td>" . $row['error'] . "</td></tr>";
                                        }
                                        if ($nrows == 0) {
