...
INSERT IGNORE INTO configuration VALUES(39,'phase_is_triphase','bool','False','','dsp', "forzatura modo di funzionamento colonnina (valido solo se force_phase e' true)", 2);
...
INSERT IGNORE INTO configuration VALUES(41,'has_plug_lockengine','bool','True','','dsp', "set modalita' funzionamento senza motorino di chiusura cavo (valido solo se force_plug_lockengine true", 2);
INSERT IGNORE INTO configuration VALUES(42,'force_plug_lockengine','bool','False','','dsp', "forzatura modalita' funzionamento con/senza motorino di chiusura cavo secondo flag has_plug_lockengine", 2);
INSERT IGNORE INTO configuration VALUES(43,'has_rfid_reader','bool','True','','dsp', "presenza rfid reader, se false colonnina funziona in modalita' senza 'login'", 2);
