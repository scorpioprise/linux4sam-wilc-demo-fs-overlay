                        ...
                        <table class="table table-sm table-hover table-borderless">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end" id="echargerlingua">
                                        <script>
                                            var lingua = '<!--#  echo var="lingua" -->';
                                            if (lingua == 'it_IT' || lingua == 'it-IT') {
                                                document.getElementById("echargerlingua").innerHTML = "<?= _TABLEITCONFIGURATIONS ?>";
                                            } else if (lingua == 'en_EN' || lingua == 'en-EN' || lingua == 'user_EN-RU') {
                                                document.getElementById("echargerlingua").innerHTML = "<?= _TABLEENCONFIGURATIONS ?>";
                                            } else if (lingua == 'ru_RU' || lingua == 'user_RU-EN') {
                                                document.getElementById("echargerlingua").innerHTML = "<?= _TABLERUCONFIGURATIONS ?>";
                                            } else {
                                                document.getElementById("echargerlingua").innerHTML = "<?= _TABLEENCONFIGURATIONS ?>";
                                            }
                                        </script>
